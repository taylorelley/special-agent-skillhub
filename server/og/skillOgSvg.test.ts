...
describe('skill OG SVG', () => {
  it('includes title, description, and labels', () => {
    const svg = buildSkillOgSvg({
      ...
      ownerLabel: '@jhillock',
      versionLabel: 'v1.2.3',
      footer: 'skillhub.ai/jhillock/discord-doctor',
    })
    ...
    expect(svg).toContain('skillhub.ai/jhillock/discord-doctor')
  })
  ...
  it('wraps long titles to avoid clipping', () => {
    const svg = buildSkillOgSvg({
      ...
      versionLabel: 'v1.0.2',
      footer: 'skillhub.ai/swiftlysisngh/excalidraw-flowchart',
    })
  ...
  it('clips and wraps long descriptions', () => {
    ...
    const svg = buildSkillOgSvg({
      ...
      ownerLabel: '@pasogott',
      versionLabel: 'v0.1.0',
      footer: 'skillhub.ai/pasogott/gurkerlcli',
    })
