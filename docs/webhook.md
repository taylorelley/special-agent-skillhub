...
SkillHub can post Discord embeds when skills are published or highlighted.
...
- `SITE_URL` (optional): Base site URL for links (default `https://skillhub.ai`).
