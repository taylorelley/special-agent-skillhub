import { getMoltHubSiteUrl, getOnlyCrabsSiteUrl } from './site'
...
const DEFAULT_DESCRIPTION = 'MoltHub — a fast skill registry for agents, with vector search.'
